  ...
  public recargarMenu(): void{
    this.items = [
        ...
        },
        {
            ...
            items:
                [
                    { label: 'HHT', codigo: 'IND_GET_HHT', routerLink: ['/app/ind/horahombrestrabajada'], icon: 'lan' },
                    ...
                    { label: 'Accidentalidad', codigo: 'IND_GET_ACD', routerLink: ['/app/ind/accidentalidad'], class: 'lan' },
