...
import { FormularioConstructorComponent } from 'src/app/website/pages/comun/components/formulario-constructor/formulario-constructor.component';
...
import { ListaInspeccionPK } from 'src/app/website/pages/inspecciones/entities/lista-inspeccion-pk';
...
@Component({
  ...
  templateUrl: './elaboracion-lista-ctr.component.html',
  styleUrls: ['./elaboracion-lista-ctr.component.scss']
})
export class ElaboracionListaCtrComponent implements OnInit {
  ...
  tipoListaOpts: SelectItem[] = tipoListaEnum;
