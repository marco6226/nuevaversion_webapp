...
import { TipoHallazgoService } from 'src/app/website/pages/inspecciones/services/tipo-hallazgo.service';

@Component({
    selector: 'app-lista-inspeccion-form-ctr',
    templateUrl: './lista-inspeccion-form-ctr.component.html',
    styleUrls: ['./lista-inspeccion-form-ctr.component.scss'],
    providers: [DirectorioService, TipoHallazgoService]
})
export class ListaInspeccionFormCtrComponent implements OnInit {
