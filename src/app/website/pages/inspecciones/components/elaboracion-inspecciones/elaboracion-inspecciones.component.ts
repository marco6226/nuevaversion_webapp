...
async onSubmit() {
    ...
    try {
        ...
        let inspeccion: Inspeccion = {
          ...
          calificacionList: [],
          respuestasCampoList: [],
          programacion: {} as Programacion,
          usuarioRegistra: new Usuario,
          usuarioModifica: new Usuario,
          empleado: new Empleado,
          listaInspeccion: {} as ListaInspeccion,
          area: new Area,
          fechavistohse: new Date,
          empleadohse: new Empleado,
          conceptohse: '',
          fechavistoing: new Date,
          empleadoing: new Empleado,
          conceptoing: ''
        }
