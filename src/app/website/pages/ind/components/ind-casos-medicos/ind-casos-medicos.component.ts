...
export class IndCasosMedicosComponent implements OnInit {
  ...
  DatosGrafica1(){
    ...
    switch (this.radioButon0) {
      case 1:
        this.datosGraf0=this.datosGraf0.filter((resp1:any)=>{return resp1['estadoDelCaso']=='1'})
        break;
      case 2:
        this.datosGraf0=this.datosGraf0.filter((resp1:any)=>{return resp1['estadoDelCaso']=='0'})
        break;
      default:
        break;
    }
  ...
  returnDatos1(){
    ...
    DatosGrafica3(){
      ...
      if(this.selectDivisiones2.length>0)this.datosGraf2=this.datosGraf2.filter((resp:any)=>resp.divisionUnidad==this.selectDivisiones2)
      ...
      this.datosGraf2.map((resp:any)=>{if(resp[nombre]==null){resp[nombre]=nombre2}})
    ...
    sumAreaSelect2(scm:any,opcion:any,flag:any,datos:any,selectOpcion:any){
      let datos0=datos
      let datos0_1
      if(flag){
        this.valueArray=[]
      ...
      opcion.forEach((resp:any)=>{
        datos0_1=datos0.filter((resp1:any)=>{return resp1[selectOpcion]==resp.value})
    ...
    agregarDivision(opcion:any){
      ...
      this.selectUbicacion2=this.selectUbicacion2.filter((resp:any)=>resp.label!="")
    ...
    DatosGrafica4(){
      ...
      this.datosGraf3.map((resp:any)=>{if(resp['tipoRetorno']==null){resp['tipoRetorno']='null'}})
    ...
    DatosGrafica5(){
      ...
      this.datosGraf4.map((resp:any)=>{if(resp['tipoRetorno']==null){resp['tipoRetorno']='null'}})
    ...
    sumAreaSelect5(scm:any,opcion:any,flag:any,datos:any,selectOpcion:any){
      let datos0=datos
      let datos0_1
      if(flag){
        this.valueArray_5=[]
    ...
    DatosGrafica6(){
      ...
      this.datosGraf5=this.datosGraf5.filter((resp:any)=>{return resp['origen']!=null})
      if(this.radioButon5==1){this.datosGraf5=this.datosGraf5.filter((resp:any)=>{return resp['origen']=='Común'})}
      if(this.radioButon5==2){this.datosGraf5=this.datosGraf5.filter((resp:any)=>{return resp['origen']!='Común'})}
    ...
    DatosGrafica7(){
      ...
      this.datosGraf6=this.datosGraf6.filter((resp:any)=>{return resp['origen']!=null})
      if(this.radioButon6==1){this.datosGraf6=this.datosGraf6.filter((resp:any)=>{return resp['origen']=='Común'})}
      if(this.radioButon6==2){this.datosGraf6=this.datosGraf6.filter((resp:any)=>{return resp['origen']!='Común'})}

      if(this.selectDivisiones6.length>0)this.datosGraf6=this.datosGraf6.filter((resp:any)=>resp.divisionUnidad==this.selectDivisiones6)

      this.datosGraf6=this.filtroFecha(this.fechaDesde7!,this.fechaHasta7!,this.datosGraf6)
      this.datosGraf6.map((resp:any)=>{if(resp['diagnostico']==null){resp['diagnostico']='Sin diagnostico'}})
      let opcion:any=[]
      let map=new Map()
    ...
    sumAreaSelect7(scm:any,opcion:any,flag:any,datos:any,selectOpcion:any){
      let datos0=datos
      let datos0_1
      if(flag){
        this.valueArray_7=[]
    ...
    agregarDivision7(opcion:any){
      ...
      this.selectUbicacion6=this.selectUbicacion6.filter((resp:any)=>resp.label!="")
