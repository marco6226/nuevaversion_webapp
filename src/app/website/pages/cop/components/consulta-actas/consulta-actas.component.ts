...
import { ActaService } from 'src/app/website/pages/core/services/acta.service';
...
export class ConsultaActasComponent implements OnInit {
  ...
  onFileSelect(file: FileList) {
      ...
      let doc:any = { nombre: fileName, ext: ext };
  ...
  removerDoc(doc: any, idx: number) {
      this.documentoList!.splice(idx, 1);
  }

  downloadFile(doc: Documento | any) {
      if (doc['file'] != null) {
