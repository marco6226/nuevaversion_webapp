...
import { DataArea, DataHht, Hht } from "src/app/website/pages/empresa/entities/hht";
...
export class DashboardCoronaComponent implements OnInit {
  ...
  calcularTotalHht(hht: Hht[], mesInicio: number, mesFinal: number, selectedDivisionResumen: string | any, flagTemporales: boolean): number{
    let totalHht = 0;
